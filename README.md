...
출력 예시:
```
[ADMIT] L-U0001-0005  score=0.3252  rel=0.1347  qual=0.1905  red_pen=0.000
        spec=0.10  act=0.60  prog=1.00  cat=implementation(core)
[REJECT] L-U0001-0012  reason=domain_conflict_veto(dm=0.70)  [주식 시장 공부]
[REDUNDANCY] L-U0001-0031  penalty=0.15  reason=similar(0.72):L-0005  [여행 준비물 쇼핑]
```
